...
public class FacilDBHelper extends SQLiteOpenHelper {
    private final static String TAG = "DataBaseHelper"; // Logcat에 출력할 태그이름
    // database 의 파일 경로
    private static String DB_PATH = "";
    private static String DB_NAME = "facil.db";
    private SQLiteDatabase mDataBase;
    private Context mContext;


    public FacilDBHelper(Context context, int version) {
    ...
    private void dbCopy() {
        ...
        try {
            ...
            InputStream inputStream = mContext.getAssets().open("databases/facil.db");
