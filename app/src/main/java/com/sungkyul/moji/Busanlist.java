...
//                android.R.layout.simple_list_item_1, list);
        ...
        if (test.equals(line_1)) {
            ...
            Cursor cursor;
            cursor = db.rawQuery("select distinct * from `부산1호선` ", null);
            tname = "";
            hosun = "1호선";
            ...
            Cursor cursor;
            cursor = db.rawQuery("select distinct * from `부산2호선` ", null);
            tname = "";
            hosun = "2호선";
            while (cursor.moveToNext()) {
                String name = cursor.getString(0);
            ...
            Cursor cursor;
            cursor = db.rawQuery("select distinct * from `부산3호선` ", null);
            tname = "";
            hosun = "3호선";
            while (cursor.moveToNext()) {
                String name = cursor.getString(0);
        ...
        ////////////////////////////////////////////////////////////
            ...
            Cursor cursor;
            cursor = db.rawQuery("select distinct * from `부산4호선` ", null);
            tname = "";
            hosun = "4호선";
            while (cursor.moveToNext()) {
                String name = cursor.getString(0);
            ...
            Cursor cursor;
            cursor = db.rawQuery("select distinct * from `부산김해선` ", null);
            tname = "";
            hosun = "부산김해경전철";
            while (cursor.moveToNext()) {
                String name = cursor.getString(0);
            ...
            Cursor cursor;
            cursor = db.rawQuery("select distinct * from `부산동해선` ", null);
            tname = "";
            hosun = "부산동해선";
            while (cursor.moveToNext()) {
                String name = cursor.getString(0);
...
//////////-----------------------------------------------------------------------------------
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                Intent it = new Intent(getApplicationContext(), BusanInfo.class);   // 인텐트 처리
