...
// ----------- 에스컬레이터 ---------------------------------------------//
        while(escalator.getText().toString().equals("")) {
            Cursor cursor;
            cursor = db.rawQuery("SELECT * FROM `대구 에스컬레이터` where `역명` = '"+station+"' ",null);
...
// ----------- 엘레베이터 ---------------------------------------------//
        while(elevator.getText().toString().equals("")) {
            Cursor cursor;
            cursor = db.rawQuery("SELECT * FROM `대구 엘리베이터` where `역명` = '"+station+"' ",null);
...
// ----------- 화장실 ---------------------------------------------//
        while(toilet.getText().toString().equals("")) {
            Cursor cursor;
            cursor = db.rawQuery("SELECT * FROM `대구 화장실` where `역명` = '"+station+"' ",null);
...
// ----------- 장애인화장실 ---------------------------------------------//
        while(disabledtoilet.getText().toString().equals("")) {
            Cursor cursor;
            cursor = db.rawQuery("SELECT * FROM `대구 장애인화장실` where `역명` = '"+station+"' ",null);
...
// ----------- 휠체어 리프트 ---------------------------------------------//
        while(wheellift.getText().toString().equals("")) {
            Cursor cursor;
            cursor = db.rawQuery("SELECT * FROM `대구 휠체어리프트` where `역명` = '"+station+"' ",null);
...
// ----------- 휠체어 충전설비 ---------------------------------------------//
        while(charge.getText().toString().equals("")) {
            Cursor cursor;
            cursor = db.rawQuery("SELECT * FROM `대구 전동휠체어 충전설비` where `역명` = '"+station+"' ",null);
...
// ----------- 고객센터 ---------------------------------------------//
        while(center.getText().toString().equals("")) {
            String rphone="";
            Cursor cursor;
            cursor = db.rawQuery("SELECT `전화번호` FROM `대구 고객센터` where `역명` = '"+station+"' and `선명` = '"+line+"' ",null);
